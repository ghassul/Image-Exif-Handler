...
def parse_args():
	...
	parser.add_argument("-t", "--title", help="Exif title data to add to image")
	parser.add_argument("-s", "--subject", help="Exif subject data to add to image")
	parser.add_argument("-g", "--tags", help="Exif tags data to add to image")
	parser.add_argument("-c", "--comments", help="Exif comments data to add to image")
	parser.add_argument("-a", "--authors", help="Exif authors data to add to image")
...
def add_exif_data(exif_data_dict, image_name='blank.jpg'):
	...
	try:
		...
		return "Exif data added onto: " + image_name
	except Exception, e:
