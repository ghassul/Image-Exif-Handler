...
def parse_args():
    """Takes the commandline arguments and returns an object"""
    parser = argparse.ArgumentParser()
    parser.add_argument("image",
                        help="Image name including file extension")
    parser.add_argument("-t", "--title",
                        help="Exif title data to add to image", default="")
    parser.add_argument("-s", "--subject",
                        help="Exif subject data to add to image", default="")
    parser.add_argument("-g", "--tags",
                        help="Exif tags data to add to image", default="")
    parser.add_argument("-c", "--comments",
                        help="Exif comments data to add to image", default="")
    parser.add_argument("-a", "--authors",
                        help="Exif authors data to add to image", default="")
...
def add_exif_data(exif_data_dict, image_name='blank.jpg'):
    """Adds input dictionary onto given image name
    (exif_dict_data, image_name)"""
